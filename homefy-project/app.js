...
const client = contentful.createClient({
    ...
    accessToken: "uftoyEOtDP90pauFJPVgH1M3SBrhp2hWGPyQwxgD1ns"
  });
...
const productsDOM = document.querySelector(".products_center");
...
class UI {
        ...
        products.forEach(product => {
            ...
            <article class="product">
                <div class="img_container">
                    ...
                    <button class="bag_btn" data-id=${product.id}>
    ...
    getBagButtons(){
        const buttons = [...document.querySelectorAll(".bag_btn")];
        buttonsDOM = buttons;
